...
export default function PrivacyPolicy() {
  return (
    <div className={style.offer}>
      <h1 className={style.offer__title}>Privacy Policy</h1>
      <p className={style.offer__updated}>Updated at 2023-10-31</p>

      <p>
        {"  "}
        nextry.app (&ldquo;we,&rdquo; &ldquo;our,&rdquo; or &ldquo;us&rdquo;) is committed to protecting your
        privacy. This Privacy Policy explains how your personal information is
        collected, used, and disclosed by nextry.app.
      </p>
      <p>
        This Privacy Policy applies to our website, and its associated
        subdomains (collectively, our &ldquo;Service&rdquo;) alongside our application,
        nextry.app. By accessing or using our Service, you signify that you have
      ...
      <div>
        ...
        <ul className={style.offer__list}>
          ...
          <li>
            Company: when this policy mentions &ldquo;Company,&rdquo; &ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our,&rdquo;
            it refers to NexTry LTD, Ketokivenkaari 20 Helsinki Finland 00710
          ...
          <li>
            ...
            up to use the nextry.app Service to manage the relationships with
            your consumers or service users.
          </li>
          <li>
            Device: any internet connected device such as a phone, tablet,
            computer or any other device that can be used to visit nextry.app
          ...
          <li>
            ...
            nextry.app or are under contract to perform a service on behalf of
            one of the parties.
          </li>
          <li>
          ...
          <li>
            Service: refers to the service provided by nextry.app as described
          ...
          <li>
            You: a person or entity that is registered with nextry.app to use
            the Services.
          </li>
        </ul>
      </div>

      <h1 className={style.offer__title}>What Information Do We Collect?</h1>
      <p>
      ...
      <ul className={style.offer__list}>
        ...
        <li>
          ...
          upload any picture straight from the website/app, you can safely deny
          camera permissions for this website/app.
        </li>
        <li>
          ...
          deny photo gallery access for this website/app.
        </li>
      </ul>
      ...
      <h1 className={style.offer__title}>
        When does nextry.app use end user information from third parties?
      </h1>
      <p>
        nextry.app will collect End User Data necessary to provide the
        nextry.app services to our customers.
      </p>
      <p>
      ...
      <h1 className={style.offer__title}>
        When does nextry.app use customer information from third parties?
      </h1>
      <p>
        ...
        in becoming a nextry.app customer, we receive information from a third
        party that provides automated fraud detection services to nextry.app. We
      ...
      <p>
        ...
        website/app. We will likely share your personal information, and
        possibly some non-personal information, with these third parties to
      ...
      <p>
        ...
        such as connection speed, whether you have visited the website/app in a
        shared location, and type of the device used to visit the website/app.
        They may aggregate information about our advertising and what you see on
        the website/app and then provide auditing, research and reporting for us
        and our advertisers. We may also disclose personal and non-personal
      ...
      <p>
        nextry.app will collect personal information that you submit to us. We
        may also receive personal information about you from third parties as
        described above.
      </p>

      <h1 className={style.offer__title}>How Do We Use Your Email Address?</h1>
      <p>
        ...
        these email lists at any time by clicking on the opt-out link or other
        ...
        commercial emails, because we hate spam as much as you do. By submitting
        your email address, you also agree to allow us to use your email address
        for customer audience targeting on sites like Facebook, where we display
      ...
      <p>
        ...
        nextry.app to you and fulfill the purposes described in this policy.
      ...
      <p>
        ...
        any information you transmit to nextry.app or guarantee that your
      ...
      <p>
        nextry.app is incorporated in Finland. Information collected via our
      ...
      <h1 className={style.offer__title}>
        Is the information collected through the nextry.app Service secure?
      </h1>
      <p>
      ...
      <p>
        ...
        nextry.app collects depend on your relationship with nextry.app.
      ...
      <h1 className={style.offer__title}>Personnel</h1>
      <p>
        If you are a nextry.app worker or applicant, we collect information you
      ...
      <h1 className={style.offer__title}>Sale of Business</h1>
      <p>
        ...
        the assets of nextry.app or any of its Corporate Affiliates (as defined
        herein), or that portion of nextry.app or any of its Corporate
      ...
      <h1 className={style.offer__title}>Affiliates</h1>
      <p>
        ...
        nextry.app, whether by ownership or otherwise. Any information relating
      ...
      <p>
        This Privacy Policy is governed by the laws of Finland without regard to
      ...
      <p>
        ...
        this Agreement and your use of the website/app. Your use of the
        website/app may also be subject to other local, state, national, or
        international laws.
      </p>
      <p>
        By using nextry.app or contacting us directly, you signify your
      ...
      <p>
        ...
        a purchase, you hereby consent to our Privacy Policy and agree to its
        terms.
      </p>
      ...
      <h1 className={style.offer__title}>Advertising</h1>
      <p>
      ...
      <h1 className={style.offer__title}>Cookies for Advertising</h1>
      <p>
        These cookies collect information over time about your online activity
        on the website/app and other online services to make online
        advertisements more relevant and effective to you. This is known as
        interest-based advertising. They also perform functions like preventing
        the same ad from continuously reappearing and ensuring that ads are
        properly displayed for advertisers. Without cookies, it’s really hard
      ...
      <h1 className={style.offer__title}>Remarketing Services</h1>
      <p>
        ...
        company to seem like they&apos;re &ldquo;following&rdquo; people around the internet by
        serving ads on the websites and platforms they use most.
      </p>
      <h1 className={style.offer__title}>Payment Details</h1>
      <p>
      ...
      <h1 className={style.offer__title}>Kids&apos; Privacy</h1>
      <p>
      ...
      <h1 className={style.offer__title}>Changes To Our Privacy Policy</h1>
      <p>
      ...
      <h1 className={style.offer__title}>Tracking Technologies</h1>
      <ul className={style.offer__list}>
        <li>
          Google Maps API
          <br />
      ...
      <h1 className={style.offer__title}>What is GDPR?</h1>
      <p>
      ...
      <h1 className={style.offer__title}>What is personal data?</h1>
      <p>
      ...
      <h1 className={style.offer__title}>Why is GDPR important?</h1>
      <p>
        ...
        At nextry.app we strongly believe that your data privacy is very
      ...
      <p>
        ...
        requirements of GDPR. nextry.app processes or stores all personal data
      ...
      <h1 className={style.offer__title}>California Residents</h1>
      <p>
