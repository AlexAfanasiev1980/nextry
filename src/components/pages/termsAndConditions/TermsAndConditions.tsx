...
export default function TermsAndConditions() {
  return (
    <div className={style.offer}>
      <h1 className={style.offer__title}>Terms & Conditions</h1>
      <p className={style.offer__updated}>Updated at 2023-10-31</p>

      <h1 className={style.offer__title}>General Terms</h1>
      <p>
        By accessing and placing an order with nextry.app, you confirm that you
      ...
      <p>
        Under no circumstances shall nextry.app team be liable for any direct,
        ...
        inability to use, the materials on this site, even if nextry.app team or
      ...
      <p>
        nextry.app will not be responsible for any outcome that may occur during
      ...
      <p>
        nextry.app grants you a revocable, non-exclusive, non-transferable,
      ...
      <ul className={style.offer__list}>
        ...
        <li>
          ...
          computer or any other device that can be used to visit nextry.app and
          use the services.
        </li>
        <li>
      ...
      <ul className={style.offer__list}>
        <li>
          ...
          outsource, disclose or otherwise commercially exploit the website/app
      ...
      <h1 className={style.offer__title}>Return and Refund Policy</h1>
      <p>
        Thanks for shopping at nextry.app. We appreciate the fact that you like
      ...
      <h1 className={style.offer__title}>Links to Other Websites</h1>
      <p>
        ...
        nextry.app. We are not responsible for the content, accuracy or opinions
      ...
      <p>
        ...
        login details every time you visit the website/app as we would not be
      ...
      <h1 className={style.offer__title}>Changes To Our Terms & Conditions</h1>
      <p>
        You acknowledge and agree that nextry.app may stop (permanently or
        ...
        specifically inform nextry.app when you stop using the Service. You
        acknowledge and agree that if nextry.app disables access to your
      ...
      <h1 className={style.offer__title}>Modifications to Our website/app</h1>
      <p>
        nextry.app reserves the right to modify, suspend or discontinue,
        temporarily or permanently, the website/app or any service to which it
        connects, with or without notice and without liability to you.
      </p>

      <h1 className={style.offer__title}>Updates to Our website/app</h1>
      <p>
      ...
      <p>
        ...
        the website/app. You agree that nextry.app has no obligation to (i)
      ...
      <p>
        ...
        integral part of the website/app, and (ii) subject to the terms and
      ...
      <h1 className={style.offer__title}>Copyright Infringement Notice</h1>
      <p>
        If you are a copyright owner or such owner’s agent and believe any
        material on our website/app constitutes an infringement on your
        ...
        material that is claimed to be infringing; (c) your contact information,
        including your address, telephone number, and an email; (d) a statement
        by you that you have a good faith belief that use of the material is not
      ...
      <p>
        ...
        implied, statutory or otherwise, with respect to the website/app,
        ...
        the website/app will meet your requirements, achieve any intended
      ...
      <p>
        ...
        (ii) that the website/app will be uninterrupted or error-free; (iii) as
        to the accuracy, reliability, or currency of any information or content
        provided through the website/app; or (iv) that the website/app, its
      ...
      <p>
        ...
        to use the website/app, third-party software and/or third-party hardware
        used with the website/app, or otherwise in connection with any provision
      ...
      <p>
        ...
        notices published by nextry.app on the Services, shall constitute the
        entire agreement between you and nextry.app concerning the Services. If
      ...
      <p>
        ...
        nextry.app regarding your use of the website/app and supersedes all
      ...
      <h1 className={style.offer__title}>Updates to Our Terms</h1>
      <p>
      ...
      <p>
        The website/app and its entire contents, features and functionality
        ...
        thereof), are owned by nextry.app, its licensors or other providers of
        ...
        without the express prior written permission of nextry.app, unless and
        except as is expressly provided in these Terms & Conditions. Any
        unauthorized use of the material is prohibited.
      </p>

      <h1 className={style.offer__title}>Agreement to Arbitrate</h1>
      <p>
      ...
      <h1 className={style.offer__title}>Notice of Dispute</h1>
      <p>
        In the event of a dispute, you or nextry.app must give the other a
        ...
        is sent. After sixty (60) days, you or nextry.app may commence
        arbitration.
      </p>

      <h1 className={style.offer__title}>Binding Arbitration</h1>
      <p>
        If you and nextry.app don’t resolve any dispute by informal negotiation,
      ...
      <h1 className={style.offer__title}>Submissions and Privacy</h1>
      <p>
        ...
        and will become the sole property of nextry.app without any compensation
        or credit to you whatsoever. nextry.app and its affiliates shall have no
      ...
      <h1 className={style.offer__title}>Promotions</h1>
      <p>
        nextry.app may, from time to time, include contests, promotions,
      ...
      <h1 className={style.offer__title}>Typographical Errors</h1>
      <p>
      ...
      <h1 className={style.offer__title}>Miscellaneous</h1>
      <p>
        ...
        of nextry.app. nextry.app will be entitled to injunctive or other
        equitable relief (without the obligations of posting any bond or surety)
        in the event of any breach or anticipatory breach by you. nextry.app
        operates and controls the nextry.app Service from its offices in . The
        ...
        choose to access the nextry.app Service from other locations do so on
        ...
        & Conditions (which include and incorporate the nextry.app Privacy
        Policy) contains the entire understanding, and supersedes all prior
        understandings, between you and nextry.app concerning its subject
