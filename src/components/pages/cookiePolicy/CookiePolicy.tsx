...
export default function CookiePolicy() {
  return (
    <div className={style.offer}>
      <h1 className={style.offer__title}>Cookie Policy</h1>
      ...
      <ul className={style.offer__list}>
        ...
        <li>
          ...
          refers to nextry.app, that is responsible for your information under
          this Cookie Policy.
        </li>
        <li>
      ...
      <h1 className={style.offer__title}>What is a cookie?</h1>
      <p>
      ...
      <h1 className={style.offer__title}>Why do we use cookies?</h1>
      <p>
        We use first party and/or third party cookies on our website/app for
      ...
      <ul className={style.offer__list}>
        ...
        <li>
          To improve your experience of our website/app and make navigating
      ...
      <h1 className={style.offer__title}>What type of cookies does nextry.app use?</h1>
      <p>
      ...
      <p>
        Strictly Necessary cookies are necessary for our website/app to function
        and cannot be switched off in our systems. They are essential in order
        to enable you to navigate around the website/app and use its features.
        If you remove or disable these cookies, we cannot guarantee that you
        will be able to use our website/app.
      </p>
      <p>We use the following types of cookies in our website/app:</p>
      <h1 className={style.offer__title}>Essential Cookies</h1>
      <p>
      ...
      <h1 className={style.offer__title}>Performance and Functionality Cookies</h1>
      <p>
        These cookies are used to enhance the performance and functionality of
        our website/app but are non-essential to their use. However, without
        these cookies, certain functionality like videos may become unavailable
        or you would be required to enter your login details every time you
        visit the website/app as we would not be able to remember that you had
        logged in previously.
      </p>
      <h1 className={style.offer__title}>Marketing Cookies</h1>
      <p>
      ...
      <h1 className={style.offer__title}>Analytics and Customization Cookies</h1>
      <p>
        These cookies collect information that is used to help us understand how
        our website/app is being used or how effective our marketing campaigns
        are, or to help us customize our website/app for you.
      </p>
      <p>
        ...
        use of our website/app. Further information on how Google collects and
        uses this data can be found
        at: https://www.google.com/policies/privacy/partners/. You can opt-out
        of all Google supported analytics on our Websites by
        visiting: https://tools.google.com/dlpage/gaoptout.
      </p>
      <h1 className={style.offer__title}>Advertising Cookies</h1>
      <p>
      ...
      <h1 className={style.offer__title}>Social Media Cookies</h1>
      <p>
      ...
      <h1 className={style.offer__title}>Third Party Cookies</h1>
      <p>
        Some cookies that have been set on our website/app are not set on a
        first party basis by nextry.app. The Websites can be embedded with
        content from third parties to serve advertising. These third party
        service providers may set their own cookies on your web browser. Third
        party service providers control many of the performance and
        functionality, advertising, marketing and analytics cookies described
        above. We do not control the use of these third party cookies as cookies
